...
<header id="header" class="fixed-top">
    <div class="container d-flex align-items-center">
        ...
        <nav id="navbar" class="navbar order-last order-lg-0">
            <ul>
                <li><a class="nav-link scrollto " href="#hero"><?= $local_strings[$lang]['home'];?></a></li>
                ...
                <li class="dropdown"><a href="#"><span><i class="fa fa-earth"></i> </span> <i class="bi bi-chevron-down"></i></a>
                    <ul>
                        <li><a href="#" onclick="changeLanguage('uz')">Uzbek</a></li>
                        <li><a href="#" onclick="changeLanguage('ru')">Русский</a></li>
                        <li><a href="#" onclick="changeLanguage('en')">English</a href="#"></li>
                    </ul>
                </li>
            </ul>
