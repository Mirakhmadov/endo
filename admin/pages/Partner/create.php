                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-md-8 offset-md-2 col-12">
                            ...
                            <input class="form-control my-2" type="search" name="name"
                                   placeholder="<? echo $local_strings[$lang]['name']; ?>">

                            <input class="form-control my-2" type="search" name="url"
                                   placeholder="<? echo $local_strings[$lang]['url']; ?>">
...
if (isset($_POST['save'])) {
    ...
    if ($check !== false) {
        ...
        response(savePartner($_POST, $_FILES['photo']), "partner");
    } else {
        ?>
